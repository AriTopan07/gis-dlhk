...
class TemplateImportPetunjukSheet implements FromArray, WithTitle, WithStyles, WithColumnWidths
{
    ...
    public function array(): array
    {
        return [
            ...
            [''],
            ['CONTOH PENGISIAN', ''],
            ['Baris', 'NAMA KORDINATOR | NIP KORDINATOR | EMAIL | PASSWORD | NAMA PENGAWAS | NAMA PETUGAS | NIK KTP PETUGAS | NIP PETUGAS'],
            ['5',     'Andi Sumarno | 198501012020011001 | andi@dlhk.go.id | password123 | Budi Santoso | Fatchul Muin | 3515072211860001 | 198611222025211088'],
            ['6',     '(kosong) | (kosong) | (kosong) | (kosong) | (kosong) | Ian Anugrish | 3515811110190900002 | 199001112025211122'],
            ['7',     '(kosong) | (kosong) | (kosong) | (kosong) | Desi Ariani | Brilian Salsabina | 3578014805030200012 | 200303080252501012'],
            ['8',     'Siti Rahayu | 197803152019012002 | (kosong) | (kosong) | Ahmad Yusuf | Rian Maulana | 3515011503850001 | (kosong)'],
            [''],
            ['CATATAN PENTING', ''],
